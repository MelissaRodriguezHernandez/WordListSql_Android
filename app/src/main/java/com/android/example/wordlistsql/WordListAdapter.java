...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        WordItem actual = wordListOpenHelperA.query(position);
        holder.wordItemView.setText(actual.getWord());
        final WordViewHolder wordViewHolder = holder;
        ...
        holder.edit_button.setOnClickListener(new MyButtonOnClickListener(
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(EXTRA_POSITION, wordViewHolder.getAdapterPosition());
    ...
    public int getItemCount() {
       return (int) wordListOpenHelperA.count();
    }
}
